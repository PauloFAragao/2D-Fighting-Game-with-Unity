...
public class TerryController : GenericCharacter
{
    ...
    //metodo que vai processar a ação falling - 48
    ...
    //metodo que vai verificar qual proxima ação tomar
   ...
   //////////////////// OUTROS ////////////////////
    ...
    //metodo que vai ajustar a posição do personagem em X
    ...
    //metodo que vai verificar se o player inseriu o comando de meia lua para frente e o botão de ação corretamente
    ...
    //metodo que vai verificar se o player inseriu o comando de meia lua para tras e o botão de ação corretamente
    ...
    //metodo que vai verificar se o player inseriu o comando c para frente e o botão de ação corretamente
    ...
    //metodo que vai verificar se o player inseriu o comando (segurar) baixo + cima + botão de ação corretamente
    ...
    //metodo que vai verificar se o player inseriu o comando de duas meia lua para frente e o botão de ação corretamente
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação active pow
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação weak punch
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação strong punch
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação weak kick
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação strong kick
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Crouched weak punch
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Crouched strong punch
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Crouched weak kick
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Crouched Strong kick
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Jumping weak punch
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Jumping Strong punch
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Jumping weak kick
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Jumping Strong kick
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Special Attack
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Jumping Special Attack
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Weak Punch Forward
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Rising Upper
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação power wave
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação round wave
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Power Dunk
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Burn Knuckle
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Rising Tackle
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Power Geyser
    ...
    //metodo responsavel por verificar se o personagem pode mudar para a ação Buster Wolf
